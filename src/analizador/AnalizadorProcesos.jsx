...
export default function AnalizadorProcesos({ onVolver }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg overflow-hidden">
        {/* Header */}
        <div className="relative flex items-center justify-center bg-blue-600 p-4">
          {onVolver && (
            <button
              type="button"
              onClick={onVolver}
              className="absolute left-3 text-white/90 hover:text-white text-sm"
            >
              ← Inicio
            </button>
          )}
